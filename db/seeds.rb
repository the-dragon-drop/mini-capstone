...
Image.create!([
  ...
  {url: "http://www.starwarshelmets.com/2007/ANH_HD_vader04.jpg", product_id: 7, name: "inquizical"}
])
...
Order.create!([
  {product_id: 5, user_id: 1, quantity: 6, subtotal: "252.0", tax: "22.68", total: "274.68"},
  {product_id: 2, user_id: 1, quantity: 10, subtotal: "2701.0", tax: "243.09", total: "2944.09"},
  {product_id: 3, user_id: 1, quantity: 4, subtotal: "6.0", tax: "0.54", total: "6.54"},
  {product_id: 2, user_id: 1, quantity: 2, subtotal: "540.2", tax: "48.62", total: "588.82"},
  {product_id: 1, user_id: 1, quantity: 25, subtotal: "224.75", tax: "20.23", total: "244.98"},
  {product_id: 1, user_id: 1, quantity: 5, subtotal: "44.95", tax: "4.05", total: "49.0"},
  {product_id: 1, user_id: 1, quantity: 5, subtotal: "44.95", tax: "4.05", total: "49.0"}
])
